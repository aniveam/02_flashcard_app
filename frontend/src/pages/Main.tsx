...
export function Main() {
  ...
  return (
    <div className="h-screen flex flex-col items-center">
      ...
      <div className="mt-[5vh] flex flex-col items-center p-5">
        <motion.p
          variants={slideVariants}
          initial="start"
          animate="end"
          transition={{ duration: 0.9 }}
          className="lg:w-2/3 text-center text-black dark:text-white text-4xl sm:text-5xl lg:text-6xl xl:text-8xl tracking-tighter">
        ...
        <motion.div
          ...
          <motion.div
            ...
            className="relative p-5 flex justify-center items-center h-auto">
            ...
            <img
              ...
              src={
                theme === "light" ? "/img/Macbook.png" : "/img/MacbookDark.png"
              }
              alt="MacBook"
            />
          </motion.div>
